...
export interface ThemeConfig {
    ...
    typography?: {
         ...
         */
        fontBody?: ('asimon-hebrew' | 'frank-ruhl-libre' | 'noto-sans-hebrew' | 'noto-serif-hebrew' | 'noto-rashi-hebrew' | 'heebo' | 'rubik' | 'assistant' | 'secular-one' | 'suez-one' | 'alef' | 'miriam-libre' | 'inter' | 'manrope' | 'dm-sans' | 'nunito' | 'epilogue' | 'mulish' | 'lexend' | 'public-sans' | 'jost' | 'sora' | 'poppins') | null;
        /**
         * Font family for headings
         */
        fontHeading?: ('asimon-hebrew' | 'frank-ruhl-libre' | 'noto-sans-hebrew' | 'noto-serif-hebrew' | 'noto-rashi-hebrew' | 'heebo' | 'rubik' | 'assistant' | 'secular-one' | 'suez-one' | 'alef' | 'miriam-libre' | 'inter' | 'manrope' | 'dm-sans' | 'nunito' | 'epilogue' | 'mulish' | 'lexend' | 'public-sans' | 'jost' | 'sora' | 'poppins') | null;
        /**
